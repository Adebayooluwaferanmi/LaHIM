...
import { ButtonVariant, ButtonType, IconType } from '../../interfaces'
import { Icon } from '../Icon'

export interface ButtonProps {
  /**
   * Determines if the button should be outlined and not filled. By default is false
   * @default false
   */
  outlined?: boolean
  ...
  style?: CSSProperties
  /**
   * Defines the class of the button icon.
   */
  iconClassName?: string
  /**
   * Defines the style of the button icon.
   */
